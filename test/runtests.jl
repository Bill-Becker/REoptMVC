...
# !!! Main.UserApp is configured as an alias for Main.REoptMVC and you might encounter it in some tests
using Main.REoptMVC, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "REoptMVC tests" begin
  @includetests ARGS
end
